# VeilPass Rust SDK Example

Demonstrates all 6 VeilPass API operations using reqwest with serde.
...
# Custom API URL
VEILPASS_API_URL=https://api.veilpass.app cargo run

# With API key
VEILPASS_API_KEY=sk_xxx cargo run
```
